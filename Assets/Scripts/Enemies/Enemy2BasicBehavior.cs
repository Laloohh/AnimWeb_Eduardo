...
public class Enemy2BasicBehavior : MonoBehaviour
{
    public int enemyHP, enemyPower;
    public float checkRadious, movement, speed;
    public Transform groundCheck, edgeCheck, obstacleCheck, obstacleCheck2, obstacleCheck3, obstacleCheck4;
    ...
    void OnDrawGizmosSelected()
    {
        ...
        Gizmos.color = Color.green;
        Gizmos.DrawWireSphere(obstacleCheck2.position, checkRadious);
        Gizmos.color = Color.green;
        Gizmos.DrawWireSphere(obstacleCheck3.position, checkRadious);
        Gizmos.color = Color.green;
        Gizmos.DrawWireSphere(obstacleCheck4.position, checkRadious);
